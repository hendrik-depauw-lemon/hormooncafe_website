...
export const updateRecurringCalendarEventInstanceFieldsSchema = z.object({
...
interface UpdateRecurringCalendarEventInstanceFieldsProps
    extends FormRenderProps<typeof updateRecurringCalendarEventInstanceFieldsSchema> {
    timezone: string;
}

export function UpdateRecurringCalendarEventInstanceFields({
    timezone,
    ...form
}: UpdateRecurringCalendarEventInstanceFieldsProps) {
