...
export function BookDetails({ initialValues }: BookDetailsProps) {
    const t = useTranslations('book.details.0.details');
            ...
            <Card>
                <CardContent>
                    ...
                    <TabsContent value="activity-log">
                        <ActivityLog entityTypeName="Book" entityId={initialValues.id} />
                    </TabsContent>
                </CardContent>
            </Card>
        </Tabs>
